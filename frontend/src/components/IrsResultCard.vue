<template>
  <section class="flex flex-col text-xs">
    <div
      class="max-w-sm mx-auto bg-gradient-to-br from-blue-500 to-blue-600 text-white rounded-2xl shadow-2xl p-8"
    >
      ...
      <button
        ...
        class="mt-8 w-full bg-blue text-blue-700 cursor-pointer font-semibold py-3 rounded-xl hover:bg-blue-50 transition duration-200"
      >
        ⬇️ Descarregar PDF
      </button>
    </div>
